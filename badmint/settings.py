"""
Django settings for badmint_project project.
...
SECRET_KEY = 'django-insecure-9#0d(r-$43n$hq&&lb6yhg^65$2f=qxh-n%lhs(zjhj=trsq5m'
...
ALLOWED_HOSTS = [
    ...
    'https://badmint-back-end-develop-7v2jv.ondigitalocean.app/',
    '127.0.0.1',
]
